        ...
        if(dblX > 0){
            ...
            if(strInitial.equals("P")) {
                ...
                if(strInitial2.equals("F")) {
                    ...
                    // Start the game
                    strTheWord = strWords[0][0];
                    intLength = strTheWord.length();

                    con.clear();
                    con.println("You have " + intLength + " tries to guess the word!");
                    ...
                    while(true) {
                        con.println("Guess the word (tries left: " + intLength + ")");
                  ...
                  con.println("Do you wanna keep playing or quit?");
                }
            }
        }
    }
